...
<p align="center">
  ...
  <h4 align="center"><a href="https://arxiv.org/abs/2312.10187">arXiv Paper</a> | <a href="IN_DEPTH_EXPLANATION.md">Beginner-Friendly Project Guide</a> | <a href="LOCAL_RUN_REPORT.md">Local Execution Report</a> | <a href="output_result.md">Benchmark Report</a></h4>
...
For a complete, beginner-friendly technical explanation, diagrams, and terminology breakdown of our local pipeline (including how we fixed the epoch loop range error), please see our **new** [IN_DEPTH_EXPLANATION.md](IN_DEPTH_EXPLANATION.md).
